...
# Wrap this up in a function for convenience in processing
# Takes a few minutes to run / parse
...
# Pull in data
cdf <- fread("../data/10k_PBMC_Multiome_nextgem_Chromium_X_atac_chr22.MD.tsv.gz")
...
save(cdf_r1, cdf_r2, cdf_f1, cdf_f2, file = "../output/summary_chr22_position_bias_multiome.rda")

#--
# Now visualize data -----
#---

load("../output/summary_chr22_position_bias_multiome.rda")
...
cowplot::ggsave2(cowplot::plot_grid(p_r1, p_f1,
                                    p_r2, p_f2), file = "../output/multiome_scATAC_chr22.pdf", 
